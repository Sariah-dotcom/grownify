  ...
  return (
    <div className="gap-3 lg:flex lg:items-center lg:gap-10">
      <div className="lg:w-1/2 lg:pl-10">
        ...
        <p className="text-center lg:text-left mt-3 px-8 lg:px-0">
      ...
      <div className="w-full lg:w-1/2 lg:border-l-2 lg:border-black">
        <div className="flex gap-16 py-10 w-full flex overflow-x-hidden">
          <img className="rotate-45 h-[20rem]" src="/test.png" alt="" />
          <img className="rotate-45 h-[20rem]" src="/test-2.png" alt="" />
        </div>

        <div className="flex gap-16 py-5 -mt-36 ml flex overflow-x-hidden lg:ml-0">
          <img className="rotate-45 h-[20rem]" src="/test-3.png" alt="" />
          <img className="rotate-45 h-[20rem]" src="/test-4.png" alt="" />
        </div>
      </div>
